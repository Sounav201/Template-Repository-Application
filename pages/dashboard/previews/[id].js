...
export default function Preview({ data }) {
  ...
  const [applicationData, setapplicationData] = useState(
    Array.isArray(application)
      ? application.length > 0 && application[0]
      : application
  );
  ...
  useEffect(() => {
    if (
      applicationData &&
      (applicationData.appbody != undefined || applicationData.appbody != null)
    ) {
  ...
  const approveHandler = async () => {
    const response = await fetch("/api/approveApplication", {
      ...
      body: JSON.stringify({
        ...
        approvalType: applicationData.approvaltype,
      }),
    });
        ...
        <div className="px-6 pt-6 2xl:container bg-[#2E0C6D] h-full">
          ...
          <Modal isOpen={isOpen} onClose={onClose}>
            ...
            <ModalContent background={"whitesmoke"}>
              ...
              <ModalBody pb={2}>
                <FormControl>
                  ...
                  <Input
                    ...
                    placeholder="Enter the email to whom you want to share"
                  />
                </FormControl>
              </ModalBody>
              ...
              <ModalFooter>
                ...
                <Button colorScheme={"telegram"} onClick={generatePDF}>
                  Send Email
                </Button>
              </ModalFooter>
            </ModalContent>
          ...
          {user.includes("Approver") && (
            <div className="p-1 flex items-center justify-between my-4  w-5/6 mx-auto ">
              ...
              <Button colorScheme="whatsapp" onClick={handleApprove}>
                Approve
              </Button>

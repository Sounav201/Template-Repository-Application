...
const Editor = () => {
  const [variables, setVariables] = useState([
    ...
    { id: 4, name: "Customer Name", data: "", click: false },
    { id: 5, name: "Product Name", data: "", click: false },
  ...
  const handleSelection = (ID) => {
    ...
    if (index != -1) setselectedVariable(variables[index]);
  };
        ...
        <div className="w-4/5  p-1 mx-auto flex flex-col items-center ">
          <div className="my-4 text-center p-1  py-4">
            ...
            <p className="text-white text-lg">
              Click on the variables as marked in the document to open up a
              right pane
            </p>
          </div>
          <div className="mt-2">

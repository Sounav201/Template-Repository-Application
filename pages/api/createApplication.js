...
export default async function handler(req, res) {
    try {
        ...
        //Variables to push into DB
        //appid , tempid , applicationType, applicationBody, email,approvalType, rejectionStatus,rejectionComments,createdOn,
        //Need to generate appID
